						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="{{URL::to('/edit_manu/'.$v_manufacture->manufacture_id)}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" id="delete" href="{{URL::to('/delete_manufacture/'.$v_manufacture->manufacture_id)}}">
