...
.paymentWrap .paymentBtnGroup .paymentMethod .method.bikash {
    background-image: url("https://i.postimg.cc/wx4CDWJH/bkash.png");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.rocket {
    background-image: url("https://i.postimg.cc/DZ68CVhx/mlogo.png");
}
